...
import com.etho.pm.repository.AgencyRepository;
import com.etho.pm.service.criteria.AgencyCriteria;
import com.etho.pm.service.dto.AgencyDTO;
import com.etho.pm.service.mapper.AgencyMapper;
...
class AgencyResourceIT {
    ...
    @Test
    @Transactional
    void getAllAgenciesByLastModifiedIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        agencyRepository.saveAndFlush(agency);

        // Get all the agencyList where lastModified is greater than or equal to DEFAULT_LAST_MODIFIED
        defaultAgencyShouldBeFound("lastModified.greaterThanOrEqual=" + DEFAULT_LAST_MODIFIED);

        // Get all the agencyList where lastModified is greater than or equal to UPDATED_LAST_MODIFIED
        defaultAgencyShouldNotBeFound("lastModified.greaterThanOrEqual=" + UPDATED_LAST_MODIFIED);
    }

    @Test
    @Transactional
    void getAllAgenciesByLastModifiedIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        agencyRepository.saveAndFlush(agency);

        // Get all the agencyList where lastModified is less than or equal to DEFAULT_LAST_MODIFIED
        defaultAgencyShouldBeFound("lastModified.lessThanOrEqual=" + DEFAULT_LAST_MODIFIED);

        // Get all the agencyList where lastModified is less than or equal to SMALLER_LAST_MODIFIED
        defaultAgencyShouldNotBeFound("lastModified.lessThanOrEqual=" + SMALLER_LAST_MODIFIED);
    }

    @Test
    @Transactional
    void getAllAgenciesByLastModifiedIsLessThanSomething() throws Exception {
        // Initialize the database
        agencyRepository.saveAndFlush(agency);

        // Get all the agencyList where lastModified is less than DEFAULT_LAST_MODIFIED
        defaultAgencyShouldNotBeFound("lastModified.lessThan=" + DEFAULT_LAST_MODIFIED);

        // Get all the agencyList where lastModified is less than UPDATED_LAST_MODIFIED
        defaultAgencyShouldBeFound("lastModified.lessThan=" + UPDATED_LAST_MODIFIED);
    }

    @Test
    @Transactional
    void getAllAgenciesByLastModifiedIsGreaterThanSomething() throws Exception {
        // Initialize the database
        agencyRepository.saveAndFlush(agency);

        // Get all the agencyList where lastModified is greater than DEFAULT_LAST_MODIFIED
        defaultAgencyShouldNotBeFound("lastModified.greaterThan=" + DEFAULT_LAST_MODIFIED);

        // Get all the agencyList where lastModified is greater than SMALLER_LAST_MODIFIED
        defaultAgencyShouldBeFound("lastModified.greaterThan=" + SMALLER_LAST_MODIFIED);
    }
