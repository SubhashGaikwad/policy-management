...
import com.etho.pm.service.RiderQueryService;
import com.etho.pm.service.RiderService;
...
/**
 * REST controller for managing {@link com.etho.pm.domain.Rider}.
 */
@RestController
@RequestMapping("/api")
public class RiderResource {
     ...
     */
    @GetMapping("/riders")
    public ResponseEntity<List<RiderDTO>> getAllRiders(RiderCriteria criteria, Pageable pageable) {
