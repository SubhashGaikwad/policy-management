...
export class BankDetailsComponent implements OnInit {
  ...
  trackId(index: number, item: IBankDetails): number {
    return item.id!;
  }

  delete(bankDetails: IBankDetails): void {
    const modalRef = this.modalService.open(BankDetailsDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
  ...
  protected onSuccess(data: IBankDetails[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
