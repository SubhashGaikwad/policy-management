...
describe('BankDetails Management Component', () => {
  let comp: BankDetailsComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(BankDetailsComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.bankDetails?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
