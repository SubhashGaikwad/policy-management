...
import com.etho.pm.service.PremiunDetailsQueryService;
import com.etho.pm.service.PremiunDetailsService;
...
/**
 * REST controller for managing {@link com.etho.pm.domain.PremiunDetails}.
 */
@RestController
@RequestMapping("/api")
public class PremiunDetailsResource {
    ...
    public ResponseEntity<List<PremiunDetailsDTO>> getAllPremiunDetails(PremiunDetailsCriteria criteria, Pageable pageable) {
