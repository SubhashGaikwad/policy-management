...
import com.etho.pm.service.PolicyQueryService;
import com.etho.pm.service.PolicyService;
...
/**
 * REST controller for managing {@link com.etho.pm.domain.Policy}.
 */
@RestController
@RequestMapping("/api")
public class PolicyResource {
     ...
     */
    @GetMapping("/policies")
    public ResponseEntity<List<PolicyDTO>> getAllPolicies(PolicyCriteria criteria, Pageable pageable) {
