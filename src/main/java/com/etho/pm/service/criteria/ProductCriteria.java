...
/**
 * Criteria class for the {@link com.etho.pm.domain.Product} entity. This class is used
 * in {@link com.etho.pm.web.rest.ProductResource} to receive all the possible filtering options from
...
public class ProductCriteria implements Serializable, Criteria {
    ...
    public ProductCriteria(ProductCriteria other) {
        ...
        this.planNo = other.planNo == null ? null : other.planNo.copy();
    ...
    public LongFilter getPlanNo() {
        return planNo;
    }

    public LongFilter planNo() {
        if (planNo == null) {
            planNo = new LongFilter();
        }
        return planNo;
    }

    public void setPlanNo(LongFilter planNo) {
        this.planNo = planNo;
    }
