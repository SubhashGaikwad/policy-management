...
import com.etho.pm.service.ParameterLookupQueryService;
import com.etho.pm.service.ParameterLookupService;
import com.etho.pm.service.criteria.ParameterLookupCriteria;
import com.etho.pm.service.dto.ParameterLookupDTO;
import com.etho.pm.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link com.etho.pm.domain.ParameterLookup}.
 */
@RestController
@RequestMapping("/api")
public class ParameterLookupResource {
    ...
    public ResponseEntity<List<ParameterLookupDTO>> getAllParameterLookups(ParameterLookupCriteria criteria, Pageable pageable) {
