...
import com.etho.pm.repository.RiderRepository;
import com.etho.pm.service.criteria.RiderCriteria;
import com.etho.pm.service.dto.RiderDTO;
import com.etho.pm.service.mapper.RiderMapper;
...
class RiderResourceIT {
    ...
    @Test
    @Transactional
    void getAllRidersByCommDateIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        riderRepository.saveAndFlush(rider);

        // Get all the riderList where commDate is greater than or equal to DEFAULT_COMM_DATE
        defaultRiderShouldBeFound("commDate.greaterThanOrEqual=" + DEFAULT_COMM_DATE);

        // Get all the riderList where commDate is greater than or equal to UPDATED_COMM_DATE
        defaultRiderShouldNotBeFound("commDate.greaterThanOrEqual=" + UPDATED_COMM_DATE);
    }

    @Test
    @Transactional
    void getAllRidersByCommDateIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        riderRepository.saveAndFlush(rider);

        // Get all the riderList where commDate is less than or equal to DEFAULT_COMM_DATE
        defaultRiderShouldBeFound("commDate.lessThanOrEqual=" + DEFAULT_COMM_DATE);

        // Get all the riderList where commDate is less than or equal to SMALLER_COMM_DATE
        defaultRiderShouldNotBeFound("commDate.lessThanOrEqual=" + SMALLER_COMM_DATE);
    }

    @Test
    @Transactional
    void getAllRidersByCommDateIsLessThanSomething() throws Exception {
        // Initialize the database
        riderRepository.saveAndFlush(rider);

        // Get all the riderList where commDate is less than DEFAULT_COMM_DATE
        defaultRiderShouldNotBeFound("commDate.lessThan=" + DEFAULT_COMM_DATE);

        // Get all the riderList where commDate is less than UPDATED_COMM_DATE
        defaultRiderShouldBeFound("commDate.lessThan=" + UPDATED_COMM_DATE);
    }

    @Test
    @Transactional
    void getAllRidersByCommDateIsGreaterThanSomething() throws Exception {
        // Initialize the database
        riderRepository.saveAndFlush(rider);

        // Get all the riderList where commDate is greater than DEFAULT_COMM_DATE
        defaultRiderShouldNotBeFound("commDate.greaterThan=" + DEFAULT_COMM_DATE);

        // Get all the riderList where commDate is greater than SMALLER_COMM_DATE
        defaultRiderShouldBeFound("commDate.greaterThan=" + SMALLER_COMM_DATE);
    }
    ...
    @Test
    @Transactional
    void getAllRidersByLastModifiedIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        riderRepository.saveAndFlush(rider);

        // Get all the riderList where lastModified is greater than or equal to DEFAULT_LAST_MODIFIED
        defaultRiderShouldBeFound("lastModified.greaterThanOrEqual=" + DEFAULT_LAST_MODIFIED);

        // Get all the riderList where lastModified is greater than or equal to UPDATED_LAST_MODIFIED
        defaultRiderShouldNotBeFound("lastModified.greaterThanOrEqual=" + UPDATED_LAST_MODIFIED);
    }

    @Test
    @Transactional
    void getAllRidersByLastModifiedIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        riderRepository.saveAndFlush(rider);

        // Get all the riderList where lastModified is less than or equal to DEFAULT_LAST_MODIFIED
        defaultRiderShouldBeFound("lastModified.lessThanOrEqual=" + DEFAULT_LAST_MODIFIED);

        // Get all the riderList where lastModified is less than or equal to SMALLER_LAST_MODIFIED
        defaultRiderShouldNotBeFound("lastModified.lessThanOrEqual=" + SMALLER_LAST_MODIFIED);
    }

    @Test
    @Transactional
    void getAllRidersByLastModifiedIsLessThanSomething() throws Exception {
        // Initialize the database
        riderRepository.saveAndFlush(rider);

        // Get all the riderList where lastModified is less than DEFAULT_LAST_MODIFIED
        defaultRiderShouldNotBeFound("lastModified.lessThan=" + DEFAULT_LAST_MODIFIED);

        // Get all the riderList where lastModified is less than UPDATED_LAST_MODIFIED
        defaultRiderShouldBeFound("lastModified.lessThan=" + UPDATED_LAST_MODIFIED);
    }

    @Test
    @Transactional
    void getAllRidersByLastModifiedIsGreaterThanSomething() throws Exception {
        // Initialize the database
        riderRepository.saveAndFlush(rider);

        // Get all the riderList where lastModified is greater than DEFAULT_LAST_MODIFIED
        defaultRiderShouldNotBeFound("lastModified.greaterThan=" + DEFAULT_LAST_MODIFIED);

        // Get all the riderList where lastModified is greater than SMALLER_LAST_MODIFIED
        defaultRiderShouldBeFound("lastModified.greaterThan=" + SMALLER_LAST_MODIFIED);
    }
