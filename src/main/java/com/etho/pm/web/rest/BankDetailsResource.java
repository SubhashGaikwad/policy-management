...
import com.etho.pm.service.BankDetailsQueryService;
import com.etho.pm.service.BankDetailsService;
...
/**
 * REST controller for managing {@link com.etho.pm.domain.BankDetails}.
 */
@RestController
@RequestMapping("/api")
public class BankDetailsResource {
    ...
    public ResponseEntity<List<BankDetailsDTO>> getAllBankDetails(BankDetailsCriteria criteria, Pageable pageable) {
