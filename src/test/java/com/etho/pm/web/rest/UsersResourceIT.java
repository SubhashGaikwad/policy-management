...
class UsersResourceIT {
    ...
    private static final LocalDate SMALLER_MARRIAGE_DATE = LocalDate.ofEpochDay(-1L);
    ...
    @Test
    @Transactional
    void getAllUsersByBirthDateIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        usersRepository.saveAndFlush(users);

        // Get all the usersList where birthDate is greater than or equal to DEFAULT_BIRTH_DATE
        defaultUsersShouldBeFound("birthDate.greaterThanOrEqual=" + DEFAULT_BIRTH_DATE);

        // Get all the usersList where birthDate is greater than or equal to UPDATED_BIRTH_DATE
        defaultUsersShouldNotBeFound("birthDate.greaterThanOrEqual=" + UPDATED_BIRTH_DATE);
    }

    @Test
    @Transactional
    void getAllUsersByBirthDateIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        usersRepository.saveAndFlush(users);

        // Get all the usersList where birthDate is less than or equal to DEFAULT_BIRTH_DATE
        defaultUsersShouldBeFound("birthDate.lessThanOrEqual=" + DEFAULT_BIRTH_DATE);

        // Get all the usersList where birthDate is less than or equal to SMALLER_BIRTH_DATE
        defaultUsersShouldNotBeFound("birthDate.lessThanOrEqual=" + SMALLER_BIRTH_DATE);
    }

    @Test
    @Transactional
    void getAllUsersByBirthDateIsLessThanSomething() throws Exception {
        // Initialize the database
        usersRepository.saveAndFlush(users);

        // Get all the usersList where birthDate is less than DEFAULT_BIRTH_DATE
        defaultUsersShouldNotBeFound("birthDate.lessThan=" + DEFAULT_BIRTH_DATE);

        // Get all the usersList where birthDate is less than UPDATED_BIRTH_DATE
        defaultUsersShouldBeFound("birthDate.lessThan=" + UPDATED_BIRTH_DATE);
    }

    @Test
    @Transactional
    void getAllUsersByBirthDateIsGreaterThanSomething() throws Exception {
        // Initialize the database
        usersRepository.saveAndFlush(users);

        // Get all the usersList where birthDate is greater than DEFAULT_BIRTH_DATE
        defaultUsersShouldNotBeFound("birthDate.greaterThan=" + DEFAULT_BIRTH_DATE);

        // Get all the usersList where birthDate is greater than SMALLER_BIRTH_DATE
        defaultUsersShouldBeFound("birthDate.greaterThan=" + SMALLER_BIRTH_DATE);
    }
    ...
    @Test
    @Transactional
    void getAllUsersByMarriageDateIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        usersRepository.saveAndFlush(users);

        // Get all the usersList where marriageDate is greater than or equal to DEFAULT_MARRIAGE_DATE
        defaultUsersShouldBeFound("marriageDate.greaterThanOrEqual=" + DEFAULT_MARRIAGE_DATE);

        // Get all the usersList where marriageDate is greater than or equal to UPDATED_MARRIAGE_DATE
        defaultUsersShouldNotBeFound("marriageDate.greaterThanOrEqual=" + UPDATED_MARRIAGE_DATE);
    }

    @Test
    @Transactional
    void getAllUsersByMarriageDateIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        usersRepository.saveAndFlush(users);

        // Get all the usersList where marriageDate is less than or equal to DEFAULT_MARRIAGE_DATE
        defaultUsersShouldBeFound("marriageDate.lessThanOrEqual=" + DEFAULT_MARRIAGE_DATE);

        // Get all the usersList where marriageDate is less than or equal to SMALLER_MARRIAGE_DATE
        defaultUsersShouldNotBeFound("marriageDate.lessThanOrEqual=" + SMALLER_MARRIAGE_DATE);
    }

    @Test
    @Transactional
    void getAllUsersByMarriageDateIsLessThanSomething() throws Exception {
        // Initialize the database
        usersRepository.saveAndFlush(users);

        // Get all the usersList where marriageDate is less than DEFAULT_MARRIAGE_DATE
        defaultUsersShouldNotBeFound("marriageDate.lessThan=" + DEFAULT_MARRIAGE_DATE);

        // Get all the usersList where marriageDate is less than UPDATED_MARRIAGE_DATE
        defaultUsersShouldBeFound("marriageDate.lessThan=" + UPDATED_MARRIAGE_DATE);
    }

    @Test
    @Transactional
    void getAllUsersByMarriageDateIsGreaterThanSomething() throws Exception {
        // Initialize the database
        usersRepository.saveAndFlush(users);

        // Get all the usersList where marriageDate is greater than DEFAULT_MARRIAGE_DATE
        defaultUsersShouldNotBeFound("marriageDate.greaterThan=" + DEFAULT_MARRIAGE_DATE);

        // Get all the usersList where marriageDate is greater than SMALLER_MARRIAGE_DATE
        defaultUsersShouldBeFound("marriageDate.greaterThan=" + SMALLER_MARRIAGE_DATE);
    }
    ...
    @Test
    @Transactional
    void getAllUsersByLicenceExpiryDateIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        usersRepository.saveAndFlush(users);

        // Get all the usersList where licenceExpiryDate is greater than or equal to DEFAULT_LICENCE_EXPIRY_DATE
        defaultUsersShouldBeFound("licenceExpiryDate.greaterThanOrEqual=" + DEFAULT_LICENCE_EXPIRY_DATE);

        // Get all the usersList where licenceExpiryDate is greater than or equal to UPDATED_LICENCE_EXPIRY_DATE
        defaultUsersShouldNotBeFound("licenceExpiryDate.greaterThanOrEqual=" + UPDATED_LICENCE_EXPIRY_DATE);
    }

    @Test
    @Transactional
    void getAllUsersByLicenceExpiryDateIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        usersRepository.saveAndFlush(users);

        // Get all the usersList where licenceExpiryDate is less than or equal to DEFAULT_LICENCE_EXPIRY_DATE
        defaultUsersShouldBeFound("licenceExpiryDate.lessThanOrEqual=" + DEFAULT_LICENCE_EXPIRY_DATE);

        // Get all the usersList where licenceExpiryDate is less than or equal to SMALLER_LICENCE_EXPIRY_DATE
        defaultUsersShouldNotBeFound("licenceExpiryDate.lessThanOrEqual=" + SMALLER_LICENCE_EXPIRY_DATE);
    }

    @Test
    @Transactional
    void getAllUsersByLicenceExpiryDateIsLessThanSomething() throws Exception {
        // Initialize the database
        usersRepository.saveAndFlush(users);

        // Get all the usersList where licenceExpiryDate is less than DEFAULT_LICENCE_EXPIRY_DATE
        defaultUsersShouldNotBeFound("licenceExpiryDate.lessThan=" + DEFAULT_LICENCE_EXPIRY_DATE);

        // Get all the usersList where licenceExpiryDate is less than UPDATED_LICENCE_EXPIRY_DATE
        defaultUsersShouldBeFound("licenceExpiryDate.lessThan=" + UPDATED_LICENCE_EXPIRY_DATE);
    }

    @Test
    @Transactional
    void getAllUsersByLicenceExpiryDateIsGreaterThanSomething() throws Exception {
        // Initialize the database
        usersRepository.saveAndFlush(users);

        // Get all the usersList where licenceExpiryDate is greater than DEFAULT_LICENCE_EXPIRY_DATE
        defaultUsersShouldNotBeFound("licenceExpiryDate.greaterThan=" + DEFAULT_LICENCE_EXPIRY_DATE);

        // Get all the usersList where licenceExpiryDate is greater than SMALLER_LICENCE_EXPIRY_DATE
        defaultUsersShouldBeFound("licenceExpiryDate.greaterThan=" + SMALLER_LICENCE_EXPIRY_DATE);
    }
    ...
    @Test
    @Transactional
    void getAllUsersByOtpExpiryTimeIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        usersRepository.saveAndFlush(users);

        // Get all the usersList where otpExpiryTime is greater than or equal to DEFAULT_OTP_EXPIRY_TIME
        defaultUsersShouldBeFound("otpExpiryTime.greaterThanOrEqual=" + DEFAULT_OTP_EXPIRY_TIME);

        // Get all the usersList where otpExpiryTime is greater than or equal to UPDATED_OTP_EXPIRY_TIME
        defaultUsersShouldNotBeFound("otpExpiryTime.greaterThanOrEqual=" + UPDATED_OTP_EXPIRY_TIME);
    }

    @Test
    @Transactional
    void getAllUsersByOtpExpiryTimeIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        usersRepository.saveAndFlush(users);

        // Get all the usersList where otpExpiryTime is less than or equal to DEFAULT_OTP_EXPIRY_TIME
        defaultUsersShouldBeFound("otpExpiryTime.lessThanOrEqual=" + DEFAULT_OTP_EXPIRY_TIME);

        // Get all the usersList where otpExpiryTime is less than or equal to SMALLER_OTP_EXPIRY_TIME
        defaultUsersShouldNotBeFound("otpExpiryTime.lessThanOrEqual=" + SMALLER_OTP_EXPIRY_TIME);
    }

    @Test
    @Transactional
    void getAllUsersByOtpExpiryTimeIsLessThanSomething() throws Exception {
        // Initialize the database
        usersRepository.saveAndFlush(users);

        // Get all the usersList where otpExpiryTime is less than DEFAULT_OTP_EXPIRY_TIME
        defaultUsersShouldNotBeFound("otpExpiryTime.lessThan=" + DEFAULT_OTP_EXPIRY_TIME);

        // Get all the usersList where otpExpiryTime is less than UPDATED_OTP_EXPIRY_TIME
        defaultUsersShouldBeFound("otpExpiryTime.lessThan=" + UPDATED_OTP_EXPIRY_TIME);
    }

    @Test
    @Transactional
    void getAllUsersByOtpExpiryTimeIsGreaterThanSomething() throws Exception {
        // Initialize the database
        usersRepository.saveAndFlush(users);

        // Get all the usersList where otpExpiryTime is greater than DEFAULT_OTP_EXPIRY_TIME
        defaultUsersShouldNotBeFound("otpExpiryTime.greaterThan=" + DEFAULT_OTP_EXPIRY_TIME);

        // Get all the usersList where otpExpiryTime is greater than SMALLER_OTP_EXPIRY_TIME
        defaultUsersShouldBeFound("otpExpiryTime.greaterThan=" + SMALLER_OTP_EXPIRY_TIME);
    }
    ...
    @Test
    @Transactional
    void getAllUsersByLastModifiedIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        usersRepository.saveAndFlush(users);

        // Get all the usersList where lastModified is greater than or equal to DEFAULT_LAST_MODIFIED
        defaultUsersShouldBeFound("lastModified.greaterThanOrEqual=" + DEFAULT_LAST_MODIFIED);

        // Get all the usersList where lastModified is greater than or equal to UPDATED_LAST_MODIFIED
        defaultUsersShouldNotBeFound("lastModified.greaterThanOrEqual=" + UPDATED_LAST_MODIFIED);
    }

    @Test
    @Transactional
    void getAllUsersByLastModifiedIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        usersRepository.saveAndFlush(users);

        // Get all the usersList where lastModified is less than or equal to DEFAULT_LAST_MODIFIED
        defaultUsersShouldBeFound("lastModified.lessThanOrEqual=" + DEFAULT_LAST_MODIFIED);

        // Get all the usersList where lastModified is less than or equal to SMALLER_LAST_MODIFIED
        defaultUsersShouldNotBeFound("lastModified.lessThanOrEqual=" + SMALLER_LAST_MODIFIED);
    }

    @Test
    @Transactional
    void getAllUsersByLastModifiedIsLessThanSomething() throws Exception {
        // Initialize the database
        usersRepository.saveAndFlush(users);

        // Get all the usersList where lastModified is less than DEFAULT_LAST_MODIFIED
        defaultUsersShouldNotBeFound("lastModified.lessThan=" + DEFAULT_LAST_MODIFIED);

        // Get all the usersList where lastModified is less than UPDATED_LAST_MODIFIED
        defaultUsersShouldBeFound("lastModified.lessThan=" + UPDATED_LAST_MODIFIED);
    }

    @Test
    @Transactional
    void getAllUsersByLastModifiedIsGreaterThanSomething() throws Exception {
        // Initialize the database
        usersRepository.saveAndFlush(users);

        // Get all the usersList where lastModified is greater than DEFAULT_LAST_MODIFIED
        defaultUsersShouldNotBeFound("lastModified.greaterThan=" + DEFAULT_LAST_MODIFIED);

        // Get all the usersList where lastModified is greater than SMALLER_LAST_MODIFIED
        defaultUsersShouldBeFound("lastModified.greaterThan=" + SMALLER_LAST_MODIFIED);
    }
