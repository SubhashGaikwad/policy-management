...
public class PolicyCriteria implements Serializable, Criteria {
    ...
    private InstantFilter commDate;
    ...
    private InstantFilter policyStartDate;

    private InstantFilter policyEndDate;
    ...
    private InstantFilter riskCoveredFrom;

    private InstantFilter riskCoveredTo;
    ...
    public InstantFilter getCommDate() {
        return commDate;
    }

    public InstantFilter commDate() {
        if (commDate == null) {
            commDate = new InstantFilter();
        }
        return commDate;
    }

    public void setCommDate(InstantFilter commDate) {
    ...
    public InstantFilter getPolicyStartDate() {
        return policyStartDate;
    }

    public InstantFilter policyStartDate() {
        if (policyStartDate == null) {
            policyStartDate = new InstantFilter();
        }
        return policyStartDate;
    }

    public void setPolicyStartDate(InstantFilter policyStartDate) {
        this.policyStartDate = policyStartDate;
    }

    public InstantFilter getPolicyEndDate() {
        return policyEndDate;
    }

    public InstantFilter policyEndDate() {
        if (policyEndDate == null) {
            policyEndDate = new InstantFilter();
        }
        return policyEndDate;
    }

    public void setPolicyEndDate(InstantFilter policyEndDate) {
    ...
    public InstantFilter getRiskCoveredFrom() {
        return riskCoveredFrom;
    }

    public InstantFilter riskCoveredFrom() {
        if (riskCoveredFrom == null) {
            riskCoveredFrom = new InstantFilter();
        }
        return riskCoveredFrom;
    }

    public void setRiskCoveredFrom(InstantFilter riskCoveredFrom) {
        this.riskCoveredFrom = riskCoveredFrom;
    }

    public InstantFilter getRiskCoveredTo() {
        return riskCoveredTo;
    }

    public InstantFilter riskCoveredTo() {
        if (riskCoveredTo == null) {
            riskCoveredTo = new InstantFilter();
        }
        return riskCoveredTo;
    }

    public void setRiskCoveredTo(InstantFilter riskCoveredTo) {
