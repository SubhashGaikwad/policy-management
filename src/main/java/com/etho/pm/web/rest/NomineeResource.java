...
import com.etho.pm.repository.NomineeRepository;
import com.etho.pm.service.NomineeQueryService;
import com.etho.pm.service.NomineeService;
...
/**
 * REST controller for managing {@link com.etho.pm.domain.Nominee}.
 */
@RestController
@RequestMapping("/api")
public class NomineeResource {
     ...
     */
    @GetMapping("/nominees")
    public ResponseEntity<List<NomineeDTO>> getAllNominees(NomineeCriteria criteria, Pageable pageable) {
