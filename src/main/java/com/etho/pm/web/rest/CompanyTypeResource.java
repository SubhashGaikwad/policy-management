...
import com.etho.pm.service.CompanyTypeQueryService;
import com.etho.pm.service.CompanyTypeService;
...
/**
 * REST controller for managing {@link com.etho.pm.domain.CompanyType}.
 */
@RestController
@RequestMapping("/api")
public class CompanyTypeResource {
    ...
    public ResponseEntity<List<CompanyTypeDTO>> getAllCompanyTypes(CompanyTypeCriteria criteria, Pageable pageable) {
