...
import com.etho.pm.repository.MemberRepository;
import com.etho.pm.service.criteria.MemberCriteria;
import com.etho.pm.service.dto.MemberDTO;
import com.etho.pm.service.mapper.MemberMapper;
...
class MemberResourceIT {
    ...
    @Test
    @Transactional
    void getAllMembersByLastModifiedIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        memberRepository.saveAndFlush(member);

        // Get all the memberList where lastModified is greater than or equal to DEFAULT_LAST_MODIFIED
        defaultMemberShouldBeFound("lastModified.greaterThanOrEqual=" + DEFAULT_LAST_MODIFIED);

        // Get all the memberList where lastModified is greater than or equal to UPDATED_LAST_MODIFIED
        defaultMemberShouldNotBeFound("lastModified.greaterThanOrEqual=" + UPDATED_LAST_MODIFIED);
    }

    @Test
    @Transactional
    void getAllMembersByLastModifiedIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        memberRepository.saveAndFlush(member);

        // Get all the memberList where lastModified is less than or equal to DEFAULT_LAST_MODIFIED
        defaultMemberShouldBeFound("lastModified.lessThanOrEqual=" + DEFAULT_LAST_MODIFIED);

        // Get all the memberList where lastModified is less than or equal to SMALLER_LAST_MODIFIED
        defaultMemberShouldNotBeFound("lastModified.lessThanOrEqual=" + SMALLER_LAST_MODIFIED);
    }

    @Test
    @Transactional
    void getAllMembersByLastModifiedIsLessThanSomething() throws Exception {
        // Initialize the database
        memberRepository.saveAndFlush(member);

        // Get all the memberList where lastModified is less than DEFAULT_LAST_MODIFIED
        defaultMemberShouldNotBeFound("lastModified.lessThan=" + DEFAULT_LAST_MODIFIED);

        // Get all the memberList where lastModified is less than UPDATED_LAST_MODIFIED
        defaultMemberShouldBeFound("lastModified.lessThan=" + UPDATED_LAST_MODIFIED);
    }

    @Test
    @Transactional
    void getAllMembersByLastModifiedIsGreaterThanSomething() throws Exception {
        // Initialize the database
        memberRepository.saveAndFlush(member);

        // Get all the memberList where lastModified is greater than DEFAULT_LAST_MODIFIED
        defaultMemberShouldNotBeFound("lastModified.greaterThan=" + DEFAULT_LAST_MODIFIED);

        // Get all the memberList where lastModified is greater than SMALLER_LAST_MODIFIED
        defaultMemberShouldBeFound("lastModified.greaterThan=" + SMALLER_LAST_MODIFIED);
    }
