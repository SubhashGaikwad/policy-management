  ...
  describe('Service methods', () => {
    it('should find an element', () => {
      const returnedFromService = Object.assign(
        {
          commDate: currentDate.format(DATE_TIME_FORMAT),
          policyStartDate: currentDate.format(DATE_TIME_FORMAT),
          policyEndDate: currentDate.format(DATE_TIME_FORMAT),
          paymentDate: currentDate.format(DATE_TIME_FORMAT),
          riskCoveredFrom: currentDate.format(DATE_TIME_FORMAT),
          riskCoveredTo: currentDate.format(DATE_TIME_FORMAT),
