...
import com.etho.pm.repository.UsersTypeRepository;
import com.etho.pm.service.UsersTypeQueryService;
import com.etho.pm.service.UsersTypeService;
...
/**
 * REST controller for managing {@link com.etho.pm.domain.UsersType}.
 */
@RestController
@RequestMapping("/api")
public class UsersTypeResource {
    ...
    public ResponseEntity<List<UsersTypeDTO>> getAllUsersTypes(UsersTypeCriteria criteria, Pageable pageable) {
