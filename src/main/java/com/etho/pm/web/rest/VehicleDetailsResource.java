...
import com.etho.pm.service.VehicleDetailsQueryService;
import com.etho.pm.service.VehicleDetailsService;
...
/**
 * REST controller for managing {@link com.etho.pm.domain.VehicleDetails}.
 */
@RestController
@RequestMapping("/api")
public class VehicleDetailsResource {
    ...
    public ResponseEntity<List<VehicleDetailsDTO>> getAllVehicleDetails(VehicleDetailsCriteria criteria, Pageable pageable) {
