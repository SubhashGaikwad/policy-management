...
public class Policy implements Serializable {
    ...
    private Instant riskCoveredFrom;

    @Column(name = "risk_covered_to")
    private Instant riskCoveredTo;
    ...
    public Policy commDate(Instant commDate) {
    ...
    public Policy policyStartDate(Instant policyStartDate) {
    ...
    public Policy policyEndDate(Instant policyEndDate) {
    ...
    public Policy paymentDate(Instant paymentDate) {
    ...
    public Instant getRiskCoveredFrom() {
        return this.riskCoveredFrom;
    }

    public Policy riskCoveredFrom(Instant riskCoveredFrom) {
        this.setRiskCoveredFrom(riskCoveredFrom);
        return this;
    }

    public void setRiskCoveredFrom(Instant riskCoveredFrom) {
        this.riskCoveredFrom = riskCoveredFrom;
    }

    public Instant getRiskCoveredTo() {
        return this.riskCoveredTo;
    }

    public Policy riskCoveredTo(Instant riskCoveredTo) {
        this.setRiskCoveredTo(riskCoveredTo);
        return this;
    }

    public void setRiskCoveredTo(Instant riskCoveredTo) {
