...
import com.etho.pm.repository.PremiunDetailsRepository;
import com.etho.pm.service.criteria.PremiunDetailsCriteria;
import com.etho.pm.service.dto.PremiunDetailsDTO;
import com.etho.pm.service.mapper.PremiunDetailsMapper;
...
class PremiunDetailsResourceIT {
    ...
    @Test
    @Transactional
    void getAllPremiunDetailsByLastModifiedIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        premiunDetailsRepository.saveAndFlush(premiunDetails);

        // Get all the premiunDetailsList where lastModified is greater than or equal to DEFAULT_LAST_MODIFIED
        defaultPremiunDetailsShouldBeFound("lastModified.greaterThanOrEqual=" + DEFAULT_LAST_MODIFIED);

        // Get all the premiunDetailsList where lastModified is greater than or equal to UPDATED_LAST_MODIFIED
        defaultPremiunDetailsShouldNotBeFound("lastModified.greaterThanOrEqual=" + UPDATED_LAST_MODIFIED);
    }

    @Test
    @Transactional
    void getAllPremiunDetailsByLastModifiedIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        premiunDetailsRepository.saveAndFlush(premiunDetails);

        // Get all the premiunDetailsList where lastModified is less than or equal to DEFAULT_LAST_MODIFIED
        defaultPremiunDetailsShouldBeFound("lastModified.lessThanOrEqual=" + DEFAULT_LAST_MODIFIED);

        // Get all the premiunDetailsList where lastModified is less than or equal to SMALLER_LAST_MODIFIED
        defaultPremiunDetailsShouldNotBeFound("lastModified.lessThanOrEqual=" + SMALLER_LAST_MODIFIED);
    }

    @Test
    @Transactional
    void getAllPremiunDetailsByLastModifiedIsLessThanSomething() throws Exception {
        // Initialize the database
        premiunDetailsRepository.saveAndFlush(premiunDetails);

        // Get all the premiunDetailsList where lastModified is less than DEFAULT_LAST_MODIFIED
        defaultPremiunDetailsShouldNotBeFound("lastModified.lessThan=" + DEFAULT_LAST_MODIFIED);

        // Get all the premiunDetailsList where lastModified is less than UPDATED_LAST_MODIFIED
        defaultPremiunDetailsShouldBeFound("lastModified.lessThan=" + UPDATED_LAST_MODIFIED);
    }

    @Test
    @Transactional
    void getAllPremiunDetailsByLastModifiedIsGreaterThanSomething() throws Exception {
        // Initialize the database
        premiunDetailsRepository.saveAndFlush(premiunDetails);

        // Get all the premiunDetailsList where lastModified is greater than DEFAULT_LAST_MODIFIED
        defaultPremiunDetailsShouldNotBeFound("lastModified.greaterThan=" + DEFAULT_LAST_MODIFIED);

        // Get all the premiunDetailsList where lastModified is greater than SMALLER_LAST_MODIFIED
        defaultPremiunDetailsShouldBeFound("lastModified.greaterThan=" + SMALLER_LAST_MODIFIED);
    }
