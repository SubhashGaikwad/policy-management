...
export class RiderService {
  ...
  protected convertDateFromClient(rider: IRider): IRider {
    return Object.assign({}, rider, {
      commDate: rider.commDate?.isValid() ? rider.commDate.format(DATE_FORMAT) : undefined,
      lastModified: rider.lastModified?.isValid() ? rider.lastModified.format(DATE_FORMAT) : undefined,
    });
  }
