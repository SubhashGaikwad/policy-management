...
import com.etho.pm.repository.BankDetailsRepository;
import com.etho.pm.service.criteria.BankDetailsCriteria;
import com.etho.pm.service.dto.BankDetailsDTO;
import com.etho.pm.service.mapper.BankDetailsMapper;
...
class BankDetailsResourceIT {
    ...
    @Test
    @Transactional
    void getAllBankDetailsByLastModifiedIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        bankDetailsRepository.saveAndFlush(bankDetails);

        // Get all the bankDetailsList where lastModified is greater than or equal to DEFAULT_LAST_MODIFIED
        defaultBankDetailsShouldBeFound("lastModified.greaterThanOrEqual=" + DEFAULT_LAST_MODIFIED);

        // Get all the bankDetailsList where lastModified is greater than or equal to UPDATED_LAST_MODIFIED
        defaultBankDetailsShouldNotBeFound("lastModified.greaterThanOrEqual=" + UPDATED_LAST_MODIFIED);
    }

    @Test
    @Transactional
    void getAllBankDetailsByLastModifiedIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        bankDetailsRepository.saveAndFlush(bankDetails);

        // Get all the bankDetailsList where lastModified is less than or equal to DEFAULT_LAST_MODIFIED
        defaultBankDetailsShouldBeFound("lastModified.lessThanOrEqual=" + DEFAULT_LAST_MODIFIED);

        // Get all the bankDetailsList where lastModified is less than or equal to SMALLER_LAST_MODIFIED
        defaultBankDetailsShouldNotBeFound("lastModified.lessThanOrEqual=" + SMALLER_LAST_MODIFIED);
    }

    @Test
    @Transactional
    void getAllBankDetailsByLastModifiedIsLessThanSomething() throws Exception {
        // Initialize the database
        bankDetailsRepository.saveAndFlush(bankDetails);

        // Get all the bankDetailsList where lastModified is less than DEFAULT_LAST_MODIFIED
        defaultBankDetailsShouldNotBeFound("lastModified.lessThan=" + DEFAULT_LAST_MODIFIED);

        // Get all the bankDetailsList where lastModified is less than UPDATED_LAST_MODIFIED
        defaultBankDetailsShouldBeFound("lastModified.lessThan=" + UPDATED_LAST_MODIFIED);
    }

    @Test
    @Transactional
    void getAllBankDetailsByLastModifiedIsGreaterThanSomething() throws Exception {
        // Initialize the database
        bankDetailsRepository.saveAndFlush(bankDetails);

        // Get all the bankDetailsList where lastModified is greater than DEFAULT_LAST_MODIFIED
        defaultBankDetailsShouldNotBeFound("lastModified.greaterThan=" + DEFAULT_LAST_MODIFIED);

        // Get all the bankDetailsList where lastModified is greater than SMALLER_LAST_MODIFIED
        defaultBankDetailsShouldBeFound("lastModified.greaterThan=" + SMALLER_LAST_MODIFIED);
    }
