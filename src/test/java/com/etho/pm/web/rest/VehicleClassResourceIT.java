...
import com.etho.pm.repository.VehicleClassRepository;
import com.etho.pm.service.criteria.VehicleClassCriteria;
import com.etho.pm.service.dto.VehicleClassDTO;
import com.etho.pm.service.mapper.VehicleClassMapper;
...
class VehicleClassResourceIT {
    ...
    @Test
    @Transactional
    void getAllVehicleClassesByLastModifiedIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        vehicleClassRepository.saveAndFlush(vehicleClass);

        // Get all the vehicleClassList where lastModified is greater than or equal to DEFAULT_LAST_MODIFIED
        defaultVehicleClassShouldBeFound("lastModified.greaterThanOrEqual=" + DEFAULT_LAST_MODIFIED);

        // Get all the vehicleClassList where lastModified is greater than or equal to UPDATED_LAST_MODIFIED
        defaultVehicleClassShouldNotBeFound("lastModified.greaterThanOrEqual=" + UPDATED_LAST_MODIFIED);
    }

    @Test
    @Transactional
    void getAllVehicleClassesByLastModifiedIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        vehicleClassRepository.saveAndFlush(vehicleClass);

        // Get all the vehicleClassList where lastModified is less than or equal to DEFAULT_LAST_MODIFIED
        defaultVehicleClassShouldBeFound("lastModified.lessThanOrEqual=" + DEFAULT_LAST_MODIFIED);

        // Get all the vehicleClassList where lastModified is less than or equal to SMALLER_LAST_MODIFIED
        defaultVehicleClassShouldNotBeFound("lastModified.lessThanOrEqual=" + SMALLER_LAST_MODIFIED);
    }

    @Test
    @Transactional
    void getAllVehicleClassesByLastModifiedIsLessThanSomething() throws Exception {
        // Initialize the database
        vehicleClassRepository.saveAndFlush(vehicleClass);

        // Get all the vehicleClassList where lastModified is less than DEFAULT_LAST_MODIFIED
        defaultVehicleClassShouldNotBeFound("lastModified.lessThan=" + DEFAULT_LAST_MODIFIED);

        // Get all the vehicleClassList where lastModified is less than UPDATED_LAST_MODIFIED
        defaultVehicleClassShouldBeFound("lastModified.lessThan=" + UPDATED_LAST_MODIFIED);
    }

    @Test
    @Transactional
    void getAllVehicleClassesByLastModifiedIsGreaterThanSomething() throws Exception {
        // Initialize the database
        vehicleClassRepository.saveAndFlush(vehicleClass);

        // Get all the vehicleClassList where lastModified is greater than DEFAULT_LAST_MODIFIED
        defaultVehicleClassShouldNotBeFound("lastModified.greaterThan=" + DEFAULT_LAST_MODIFIED);

        // Get all the vehicleClassList where lastModified is greater than SMALLER_LAST_MODIFIED
        defaultVehicleClassShouldBeFound("lastModified.greaterThan=" + SMALLER_LAST_MODIFIED);
    }
