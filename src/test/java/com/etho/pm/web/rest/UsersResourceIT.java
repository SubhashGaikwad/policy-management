...
class UsersResourceIT {
    ...
    private static final Instant DEFAULT_LICENCE_EXPIRY_DATE = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_LICENCE_EXPIRY_DATE = Instant.now().truncatedTo(ChronoUnit.MILLIS);
