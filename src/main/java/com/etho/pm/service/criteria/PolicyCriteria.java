...
public class PolicyCriteria implements Serializable, Criteria {
    ...
    private LocalDateFilter commDate;
    ...
    private LocalDateFilter policyStartDate;

    private LocalDateFilter policyEndDate;
    ...
    private LocalDateFilter riskCoveredFrom;

    private LocalDateFilter riskCoveredTo;
    ...
    public LocalDateFilter getCommDate() {
        return commDate;
    }

    public LocalDateFilter commDate() {
        if (commDate == null) {
            commDate = new LocalDateFilter();
        }
        return commDate;
    }

    public void setCommDate(LocalDateFilter commDate) {
    ...
    public LocalDateFilter getPolicyStartDate() {
        return policyStartDate;
    }

    public LocalDateFilter policyStartDate() {
        if (policyStartDate == null) {
            policyStartDate = new LocalDateFilter();
        }
        return policyStartDate;
    }

    public void setPolicyStartDate(LocalDateFilter policyStartDate) {
        this.policyStartDate = policyStartDate;
    }

    public LocalDateFilter getPolicyEndDate() {
        return policyEndDate;
    }

    public LocalDateFilter policyEndDate() {
        if (policyEndDate == null) {
            policyEndDate = new LocalDateFilter();
        }
        return policyEndDate;
    }

    public void setPolicyEndDate(LocalDateFilter policyEndDate) {
    ...
    public LocalDateFilter getRiskCoveredFrom() {
        return riskCoveredFrom;
    }

    public LocalDateFilter riskCoveredFrom() {
        if (riskCoveredFrom == null) {
            riskCoveredFrom = new LocalDateFilter();
        }
        return riskCoveredFrom;
    }

    public void setRiskCoveredFrom(LocalDateFilter riskCoveredFrom) {
        this.riskCoveredFrom = riskCoveredFrom;
    }

    public LocalDateFilter getRiskCoveredTo() {
        return riskCoveredTo;
    }

    public LocalDateFilter riskCoveredTo() {
        if (riskCoveredTo == null) {
            riskCoveredTo = new LocalDateFilter();
        }
        return riskCoveredTo;
    }

    public void setRiskCoveredTo(LocalDateFilter riskCoveredTo) {
    ...
    public LocalDateFilter maturityDate() {
        if (maturityDate == null) {
            maturityDate = new LocalDateFilter();
        }
        return maturityDate;
    }
