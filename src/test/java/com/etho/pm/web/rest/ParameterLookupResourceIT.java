...
import com.etho.pm.repository.ParameterLookupRepository;
import com.etho.pm.service.criteria.ParameterLookupCriteria;
import com.etho.pm.service.dto.ParameterLookupDTO;
import com.etho.pm.service.mapper.ParameterLookupMapper;
...
class ParameterLookupResourceIT {
    ...
    @Test
    @Transactional
    void getAllParameterLookupsByLastModifiedIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        parameterLookupRepository.saveAndFlush(parameterLookup);

        // Get all the parameterLookupList where lastModified is greater than or equal to DEFAULT_LAST_MODIFIED
        defaultParameterLookupShouldBeFound("lastModified.greaterThanOrEqual=" + DEFAULT_LAST_MODIFIED);

        // Get all the parameterLookupList where lastModified is greater than or equal to UPDATED_LAST_MODIFIED
        defaultParameterLookupShouldNotBeFound("lastModified.greaterThanOrEqual=" + UPDATED_LAST_MODIFIED);
    }

    @Test
    @Transactional
    void getAllParameterLookupsByLastModifiedIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        parameterLookupRepository.saveAndFlush(parameterLookup);

        // Get all the parameterLookupList where lastModified is less than or equal to DEFAULT_LAST_MODIFIED
        defaultParameterLookupShouldBeFound("lastModified.lessThanOrEqual=" + DEFAULT_LAST_MODIFIED);

        // Get all the parameterLookupList where lastModified is less than or equal to SMALLER_LAST_MODIFIED
        defaultParameterLookupShouldNotBeFound("lastModified.lessThanOrEqual=" + SMALLER_LAST_MODIFIED);
    }

    @Test
    @Transactional
    void getAllParameterLookupsByLastModifiedIsLessThanSomething() throws Exception {
        // Initialize the database
        parameterLookupRepository.saveAndFlush(parameterLookup);

        // Get all the parameterLookupList where lastModified is less than DEFAULT_LAST_MODIFIED
        defaultParameterLookupShouldNotBeFound("lastModified.lessThan=" + DEFAULT_LAST_MODIFIED);

        // Get all the parameterLookupList where lastModified is less than UPDATED_LAST_MODIFIED
        defaultParameterLookupShouldBeFound("lastModified.lessThan=" + UPDATED_LAST_MODIFIED);
    }

    @Test
    @Transactional
    void getAllParameterLookupsByLastModifiedIsGreaterThanSomething() throws Exception {
        // Initialize the database
        parameterLookupRepository.saveAndFlush(parameterLookup);

        // Get all the parameterLookupList where lastModified is greater than DEFAULT_LAST_MODIFIED
        defaultParameterLookupShouldNotBeFound("lastModified.greaterThan=" + DEFAULT_LAST_MODIFIED);

        // Get all the parameterLookupList where lastModified is greater than SMALLER_LAST_MODIFIED
        defaultParameterLookupShouldBeFound("lastModified.greaterThan=" + SMALLER_LAST_MODIFIED);
    }
