...
import com.etho.pm.repository.VehicleDetailsRepository;
import com.etho.pm.service.criteria.VehicleDetailsCriteria;
import com.etho.pm.service.dto.VehicleDetailsDTO;
import com.etho.pm.service.mapper.VehicleDetailsMapper;
...
class VehicleDetailsResourceIT {
    ...
    @Test
    @Transactional
    void getAllVehicleDetailsByRegistrationDateIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        vehicleDetailsRepository.saveAndFlush(vehicleDetails);

        // Get all the vehicleDetailsList where registrationDate is greater than or equal to DEFAULT_REGISTRATION_DATE
        defaultVehicleDetailsShouldBeFound("registrationDate.greaterThanOrEqual=" + DEFAULT_REGISTRATION_DATE);

        // Get all the vehicleDetailsList where registrationDate is greater than or equal to UPDATED_REGISTRATION_DATE
        defaultVehicleDetailsShouldNotBeFound("registrationDate.greaterThanOrEqual=" + UPDATED_REGISTRATION_DATE);
    }

    @Test
    @Transactional
    void getAllVehicleDetailsByRegistrationDateIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        vehicleDetailsRepository.saveAndFlush(vehicleDetails);

        // Get all the vehicleDetailsList where registrationDate is less than or equal to DEFAULT_REGISTRATION_DATE
        defaultVehicleDetailsShouldBeFound("registrationDate.lessThanOrEqual=" + DEFAULT_REGISTRATION_DATE);

        // Get all the vehicleDetailsList where registrationDate is less than or equal to SMALLER_REGISTRATION_DATE
        defaultVehicleDetailsShouldNotBeFound("registrationDate.lessThanOrEqual=" + SMALLER_REGISTRATION_DATE);
    }

    @Test
    @Transactional
    void getAllVehicleDetailsByRegistrationDateIsLessThanSomething() throws Exception {
        // Initialize the database
        vehicleDetailsRepository.saveAndFlush(vehicleDetails);

        // Get all the vehicleDetailsList where registrationDate is less than DEFAULT_REGISTRATION_DATE
        defaultVehicleDetailsShouldNotBeFound("registrationDate.lessThan=" + DEFAULT_REGISTRATION_DATE);

        // Get all the vehicleDetailsList where registrationDate is less than UPDATED_REGISTRATION_DATE
        defaultVehicleDetailsShouldBeFound("registrationDate.lessThan=" + UPDATED_REGISTRATION_DATE);
    }

    @Test
    @Transactional
    void getAllVehicleDetailsByRegistrationDateIsGreaterThanSomething() throws Exception {
        // Initialize the database
        vehicleDetailsRepository.saveAndFlush(vehicleDetails);

        // Get all the vehicleDetailsList where registrationDate is greater than DEFAULT_REGISTRATION_DATE
        defaultVehicleDetailsShouldNotBeFound("registrationDate.greaterThan=" + DEFAULT_REGISTRATION_DATE);

        // Get all the vehicleDetailsList where registrationDate is greater than SMALLER_REGISTRATION_DATE
        defaultVehicleDetailsShouldBeFound("registrationDate.greaterThan=" + SMALLER_REGISTRATION_DATE);
    }
    ...
    @Test
    @Transactional
    void getAllVehicleDetailsByLastModifiedIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        vehicleDetailsRepository.saveAndFlush(vehicleDetails);

        // Get all the vehicleDetailsList where lastModified is greater than or equal to DEFAULT_LAST_MODIFIED
        defaultVehicleDetailsShouldBeFound("lastModified.greaterThanOrEqual=" + DEFAULT_LAST_MODIFIED);

        // Get all the vehicleDetailsList where lastModified is greater than or equal to UPDATED_LAST_MODIFIED
        defaultVehicleDetailsShouldNotBeFound("lastModified.greaterThanOrEqual=" + UPDATED_LAST_MODIFIED);
    }

    @Test
    @Transactional
    void getAllVehicleDetailsByLastModifiedIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        vehicleDetailsRepository.saveAndFlush(vehicleDetails);

        // Get all the vehicleDetailsList where lastModified is less than or equal to DEFAULT_LAST_MODIFIED
        defaultVehicleDetailsShouldBeFound("lastModified.lessThanOrEqual=" + DEFAULT_LAST_MODIFIED);

        // Get all the vehicleDetailsList where lastModified is less than or equal to SMALLER_LAST_MODIFIED
        defaultVehicleDetailsShouldNotBeFound("lastModified.lessThanOrEqual=" + SMALLER_LAST_MODIFIED);
    }

    @Test
    @Transactional
    void getAllVehicleDetailsByLastModifiedIsLessThanSomething() throws Exception {
        // Initialize the database
        vehicleDetailsRepository.saveAndFlush(vehicleDetails);

        // Get all the vehicleDetailsList where lastModified is less than DEFAULT_LAST_MODIFIED
        defaultVehicleDetailsShouldNotBeFound("lastModified.lessThan=" + DEFAULT_LAST_MODIFIED);

        // Get all the vehicleDetailsList where lastModified is less than UPDATED_LAST_MODIFIED
        defaultVehicleDetailsShouldBeFound("lastModified.lessThan=" + UPDATED_LAST_MODIFIED);
    }

    @Test
    @Transactional
    void getAllVehicleDetailsByLastModifiedIsGreaterThanSomething() throws Exception {
        // Initialize the database
        vehicleDetailsRepository.saveAndFlush(vehicleDetails);

        // Get all the vehicleDetailsList where lastModified is greater than DEFAULT_LAST_MODIFIED
        defaultVehicleDetailsShouldNotBeFound("lastModified.greaterThan=" + DEFAULT_LAST_MODIFIED);

        // Get all the vehicleDetailsList where lastModified is greater than SMALLER_LAST_MODIFIED
        defaultVehicleDetailsShouldBeFound("lastModified.greaterThan=" + SMALLER_LAST_MODIFIED);
    }
