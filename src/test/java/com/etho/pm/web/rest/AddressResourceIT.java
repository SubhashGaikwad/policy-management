...
import com.etho.pm.repository.AddressRepository;
...
class AddressResourceIT {
    ...
    @Test
    @Transactional
    void getAllAddressesByUsersIsEqualToSomething() throws Exception {
        // Initialize the database
        addressRepository.saveAndFlush(address);
        Users users;
        ...
        // Get all the addressList where users equals to usersId
        defaultAddressShouldBeFound("usersId.equals=" + usersId);

        // Get all the addressList where users equals to (usersId + 1)
        defaultAddressShouldNotBeFound("usersId.equals=" + (usersId + 1));
    }
