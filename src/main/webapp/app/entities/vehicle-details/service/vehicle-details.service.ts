...
export class VehicleDetailsService {
  ...
  protected convertDateFromClient(vehicleDetails: IVehicleDetails): IVehicleDetails {
    return Object.assign({}, vehicleDetails, {
      registrationDate: vehicleDetails.registrationDate?.isValid() ? vehicleDetails.registrationDate.format(DATE_FORMAT) : undefined,
      lastModified: vehicleDetails.lastModified?.isValid() ? vehicleDetails.lastModified.format(DATE_FORMAT) : undefined,
    });
  }
