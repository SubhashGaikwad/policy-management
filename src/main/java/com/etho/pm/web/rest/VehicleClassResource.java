...
import com.etho.pm.service.VehicleClassQueryService;
import com.etho.pm.service.VehicleClassService;
...
/**
 * REST controller for managing {@link com.etho.pm.domain.VehicleClass}.
 */
@RestController
@RequestMapping("/api")
public class VehicleClassResource {
    ...
    public ResponseEntity<List<VehicleClassDTO>> getAllVehicleClasses(VehicleClassCriteria criteria, Pageable pageable) {
