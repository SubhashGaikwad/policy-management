...
public class Policy implements Serializable {
    ...
    public Policy commDate(LocalDate commDate) {
    ...
    public Policy policyEndDate(LocalDate policyEndDate) {
    ...
    public Policy paymentDate(LocalDate paymentDate) {
    ...
    public Policy riskCoveredFrom(LocalDate riskCoveredFrom) {
    ...
    public Policy riskCoveredTo(LocalDate riskCoveredTo) {
    ...
    public Policy maturityDate(LocalDate maturityDate) {
    ...
    public Policy lastModified(LocalDate lastModified) {
