...
class PolicyResourceIT {
    ...
    private static final Instant DEFAULT_COMM_DATE = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_COMM_DATE = Instant.now().truncatedTo(ChronoUnit.MILLIS);
    ...
    private static final Instant DEFAULT_POLICY_START_DATE = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_POLICY_START_DATE = Instant.now().truncatedTo(ChronoUnit.MILLIS);

    private static final Instant DEFAULT_POLICY_END_DATE = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_POLICY_END_DATE = Instant.now().truncatedTo(ChronoUnit.MILLIS);
    ...
    private static final Instant DEFAULT_RISK_COVERED_FROM = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_RISK_COVERED_FROM = Instant.now().truncatedTo(ChronoUnit.MILLIS);

    private static final Instant DEFAULT_RISK_COVERED_TO = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_RISK_COVERED_TO = Instant.now().truncatedTo(ChronoUnit.MILLIS);
